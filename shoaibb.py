...
\033[1;92m:•◈•┃┃╱┃┃╭╮┣━━┃┃━┫┃━┫╰╯┃
\033[1;92m:•◈•╰╯╱╰┻╯╰┻━━┻━━┻━━┻━━╯
 ̲̲̅̅н̲̲̅̅α̲̲̅̅c̲̲̅̅k̲̲̅̅є̲̲̅̅я̲̲̅̅]─━─━─━─━≫
\033[1;92m:•◈•╭━━━╮╱╱╱╭╮
\033[1;92m:•◈•┃╭━╮┃╱╱╱┃┃
\033[1;92m:•◈•┃┃╱┃┣━━┳┫╰━╮
\033[1;92m:•◈•┃╰━╯┃╭╮┣┫╭╮┃
...
os.system("clear")
print  """
\033[1;92m:•◈•──────────────────────────────────\033[1;92m:•◈•──────── \033[1;92m:•◈•─██████████████─██████─────────███\033[1;92m:•◈•███████─ \033[1;92m:•◈•─██▒▒▒▒▒▒▒▒▒▒██─██▒▒██─────────██▒\033[1;92m:•◈•▒▒▒▒▒██─ \033[1;92m:•◈•─██▒▒██████▒▒██─██▒▒██─────────███\033[1;92m:•◈•█▒▒████─ \033[1;92m:•◈•─██▒▒██──██▒▒██─██▒▒██───────────█\033[1;92m:•◈•█▒▒██─── \033[1;92m:•◈•─██▒▒██████▒▒██─██▒▒██───────────█\033[1;92m:•◈•█▒▒██─── \033[1;92m:•◈•─██▒▒▒▒▒▒▒▒▒▒██─██▒▒██───────────█\033[1;92m:•◈•█▒▒██─── \033[1;92m:•◈•─██▒▒██████▒▒██─██▒▒██───────────█\033[1;92m:•◈•█▒▒██─── \033[1;92m:•◈•─██▒▒██──██▒▒██─██▒▒██───────────█\033[1;92m:•◈•█▒▒██─── \033[1;92m:•◈•─██▒▒██──██▒▒██─██▒▒██████████─███\033[1;92m:•◈•█▒▒████─ \033[1;92m:•◈•─██▒▒██──██▒▒██─██▒▒▒▒▒▒▒▒▒▒██─██▒\033[1;92m:•◈•▒▒▒▒▒██─ \033[1;92m:•◈•─██████──██████─██████████████─███\033[1;92m:•◈•███████─ ──────────────────────────────────────────
\033[1;92m•◈••◈••◈••◈•\033[1;94m••࿇ ══━━━━✥◈✥━━━━══ ࿇•\033[1;94m•◈••◈••◈••◈•
\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬My Love Haseeb Sajjad▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
jalan('\033[1;91m━━━━━ Loading Now Blouch Hacker Zone━━━━━')
jalan("\033[1;92m▬▬20%")
jalan('\033[1;95m▬▬▬30%')
jalan('\033[1;94m▬▬▬▬40%')  
jalan("\033[1;96m▬▬▬▬▬50%")  
...
def login():
	...
	try:
		...
		print "\033[1;94m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;91mShoaib\033[1;94m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
def menu():
	...
	print "\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;93mshoaib̳ H̳a̳c̳k̳er̳\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"
...
def pilih_super():
	...
	print "\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93m H̲a̲c̲k̲e̲r̲\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mAli H̲a̲c̲k̲e̲r̲\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
